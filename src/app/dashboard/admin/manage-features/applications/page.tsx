          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="mt-4 flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-1.5 px-4 text-xs rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    Search
                  </button>
                </div>
                  ...
                  {apps.length === 0 ? (
                    ...
                    apps.map((app) => (
                      <tr key={app.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-2 text-xs text-gray-900">{app.id}</td>
                        <td className="px-4 py-2">
                          <img
                            src={app.avatar || '/api/placeholder/24/24'}
                            alt={app.name}
                            className="w-6 h-6 rounded-full object-cover"
                          />
                        </td>
                        <td className="px-4 py-2 text-xs text-gray-900">{app.name}</td>
                        <td className="px-4 py-2 text-xs text-blue-600 hover:text-blue-800">
                          <a href={app.website} target="_blank" rel="noopener noreferrer">
                            {app.website}
                          </a>
                        </td>
                        <td className="px-4 py-2 text-xs text-gray-900 truncate max-w-xs">
                          {app.callbackUrl}
                        </td>
                        <td className="px-4 py-2 text-xs text-gray-900 truncate max-w-xs">
                          {app.description}
            ...
            <div className="px-4 py-3 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex items-center gap-1">
                  <button
                    className="p-1.5 rounded-md border border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                    disabled={true}
                  >
