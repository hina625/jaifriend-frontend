...
const AdminUsersPage: React.FC = () => {
  ...
  const fetchUsers = async (page = 1) => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'https://jaifriend-bacnd-production.up.railway.app'}/api/admin/users?page=${page}&limit=15&sortBy=${sortBy}&sortOrder=${sortOrder}`,
        {
  ...
  const fetchUserStats = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'https://jaifriend-bacnd-production.up.railway.app'}/api/admin/stats`,
        {
          headers: { 'Authorization': `Bearer ${token}` }
        }
      );
  ...
  const handleUserAction = async (userId: string, action: string) => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'https://jaifriend-bacnd-production.up.railway.app'}/api/admin/users/${userId}/${action}`,
        {
          method: 'POST',
          headers: { 'Authorization': `Bearer ${token}` }
        }
  ...
  const handleBulkAction = async (action: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || 'https://jaifriend-bacnd-production.up.railway.app'}/api/admin/users/bulk/${action}`,
        {
          method: 'POST',
          headers: {
            ...
            <div className="p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <img
                    src={selectedUser.avatar || '/avatars/1.png.png'}
