  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="p-4 lg:p-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">Add New Language & Key</h1>
          <div className="text-sm text-gray-600 flex items-center">
            <Home className="w-4 h-4 mr-1" />
            Home {'>'} Languages {'>'} <span className="text-red-500 font-semibold">Add New Language & Key</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">Add New Language</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder=""
                />
                <p className="text-xs text-gray-500 mt-1">Use only english letters, no spaces allowed. E.g: russian</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-semibold text-gray-800">Add New Language Key</h2>
            </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h3 className="text-lg font-semibold text-gray-800 mb-4">Language Management Tips</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-medium text-gray-700 mb-2">Adding Languages</h4>
            ...
            <div>
              <h4 className="font-medium text-gray-700 mb-2">Adding Language Keys</h4>
              <ul className="text-sm text-gray-600 space-y-1">
