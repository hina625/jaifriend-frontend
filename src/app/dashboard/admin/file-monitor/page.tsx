...
const FileMonitorPage: React.FC = () => {
  ...
  const fetchStatus = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:5000/api/filemonitor/status');
  ...
  const startMonitoring = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:5000/api/filemonitor/start', {
        method: 'POST'
      });
      const data = await response.json();
  ...
  const stopMonitoring = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:5000/api/filemonitor/stop', {
        method: 'POST'
      });
      const data = await response.json();
  ...
  const runCleanup = async () => {
    try {
      setLoading(true);
      const response = await fetch('http://localhost:5000/api/filemonitor/cleanup', {
        method: 'POST'
      });
      const data = await response.json();
