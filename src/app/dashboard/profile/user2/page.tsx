...
const User2Profile = () => {
  ...
  const [user, setUser] = useState<User | null>({
    ...
    bio: 'Digital Artist | Creative Designer | Nature Lover 🌿',
    location: 'Lahore, Pakistan',
    website: 'https://fatimaali.art',
  ...
  // Sample posts for user2
  const samplePosts: Post[] = [
    {
      _id: 'post3',
      content: 'Just finished my latest digital artwork! 🎨 The creative process is so therapeutic. What do you think? #digitalart #creativity',
      media: ['https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=500'],
      likes: ['user1', 'user3', 'user5'],
      comments: [],
      shares: [],
      views: ['user1', 'user3', 'user5', 'user6'],
    ...
    {
      _id: 'post4',
      content: 'Morning walk in the botanical gardens 🌸 Nature always inspires my best work! #nature #inspiration',
      media: ['https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500'],
      likes: ['user1', 'user3', 'user4', 'user6'],
      comments: [],
      shares: [],
      views: ['user1', 'user3', 'user4', 'user5', 'user6'],
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={user?.website} className="text-purple-500 hover:underline">{user?.website}</a>
              </div>
              <div className="flex items-center gap-3">
