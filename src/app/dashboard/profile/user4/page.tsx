...
const User4Profile = () => {
  ...
  const [user, setUser] = useState<User | null>({
    ...
    bio: 'Fashion Designer | Style Blogger | Creative Entrepreneur 👗',
    location: 'Faisalabad, Pakistan',
    website: 'https://ayeshamalikfashion.com',
    phone: '+92-303-4567890',
    dateOfBirth: '1993-05-14',
    gender: 'Female',
    workplace: 'Malik Fashion House',
    country: 'Pakistan',
    address: 'D Ground, Faisalabad',
    followers: ['user2', 'user3', 'user5'],
  ...
  // Sample posts for user4
  const samplePosts: Post[] = [
    {
      _id: 'post7',
      content: 'New collection preview! ✨ Spring/Summer 2024 is all about vibrant colors and sustainable fabrics. #fashion #sustainability #springcollection',
      media: ['https://images.unsplash.com/photo-1445205170230-053b83016050?w=500'],
      likes: ['user2', 'user3', 'user5'],
      comments: [],
      shares: [],
      views: ['user2', 'user3', 'user5', 'user6'],
    ...
    {
      _id: 'post8',
      content: 'Behind the scenes at our latest photo shoot! 📸 Fashion is not just about clothes, it\'s about expressing yourself. #fashionphotography #behindthescenes',
      media: ['https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=500'],
      likes: ['user2', 'user3'],
      comments: [],
      shares: [],
      views: ['user2', 'user3', 'user5'],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Profile Header */}
      <div className="bg-gradient-to-r from-pink-400 to-red-400">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1 text-white">
              ...
              {/* Stats */}
              <div className="flex gap-6 text-sm text-pink-100">
