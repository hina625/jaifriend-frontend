...
const User3Profile = () => {
  ...
  const [user, setUser] = useState<User | null>({
    ...
    bio: 'Fitness Trainer | Health Coach | Motivational Speaker 💪',
    location: 'Islamabad, Pakistan',
    website: 'https://hassanfitness.com',
  ...
  // Sample posts for user3
  const samplePosts: Post[] = [
    {
      _id: 'post5',
      content: 'Morning workout complete! 💪 Remember, consistency is key to achieving your fitness goals. #fitness #motivation #healthylifestyle',
      media: ['https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500'],
      likes: ['user1', 'user2', 'user4', 'user5'],
      comments: [],
      shares: [],
      views: ['user1', 'user2', 'user4', 'user5', 'user6'],
    ...
    {
      _id: 'post6',
      content: 'Nutrition tip of the day: Start your morning with a protein-rich breakfast to fuel your day! 🥗 #nutrition #health',
      media: [],
