...
const User6Profile = () => {
  ...
  const [user, setUser] = useState<User | null>({
    ...
    website: 'https://sanatravels.com',
    phone: '+92-305-6789012',
    dateOfBirth: '1996-09-18',
    gender: 'Female',
    workplace: 'Freelance Travel Writer',
    country: 'Pakistan',
  ...
  // Sample posts for user6
  const samplePosts: Post[] = [
    {
      _id: 'post11',
      content: 'Exploring the ancient ruins of Mohenjo-daro! 🏛️ The history here is absolutely fascinating. Every stone tells a story. #travel #pakistan #history #mohenjodaro',
      media: ['https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=500'],
    ...
    {
      _id: 'post12',
      content: 'Sunset at the Badshahi Mosque in Lahore! 🌅 The golden hour makes everything magical. #sunset #lahore #badshahimosque #photography',
      media: ['https://images.unsplash.com/photo-1564507592333-c60657eea523?w=500'],
      likes: ['user1', 'user2', 'user4', 'user5'],
      comments: [],
      shares: [],
      views: ['user1', 'user2', 'user4', 'user5'],
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={user?.website} className="text-teal-500 hover:underline">{user?.website}</a>
              </div>
              <div className="flex items-center gap-3">
