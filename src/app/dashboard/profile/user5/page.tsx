...
const User5Profile = () => {
  ...
  const [user, setUser] = useState<User | null>({
    ...
    bio: 'Chef | Food Blogger | Culinary Instructor 🍳',
    location: 'Peshawar, Pakistan',
    website: 'https://usmanchef.com',
    phone: '+92-304-5678901',
    dateOfBirth: '1988-12-03',
    gender: 'Male',
    workplace: 'Spice Garden Restaurant',
    country: 'Pakistan',
  ...
  // Sample posts for user5
  const samplePosts: Post[] = [
    {
      _id: 'post9',
      content: 'Today\'s special: Traditional Peshawari Karahi! 🔥 The secret is in the slow cooking and authentic spices. #peshawarifood #karahi #traditional',
      media: ['https://images.unsplash.com/photo-1565299624946-b28f40a0ca4b?w=500'],
      likes: ['user1', 'user2', 'user3', 'user4'],
      comments: [],
      shares: [],
      views: ['user1', 'user2', 'user3', 'user4', 'user6'],
    ...
    {
      _id: 'post10',
      content: 'Cooking class this weekend! Learn to make the perfect biryani from scratch. Limited seats available. DM for registration! 👨‍🍳 #cookingclass #biryani',
      media: [],
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Profile Header */}
      <div className="bg-gradient-to-r from-orange-400 to-yellow-500">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={user?.website} className="text-orange-500 hover:underline">{user?.website}</a>
              </div>
              <div className="flex items-center gap-3">
