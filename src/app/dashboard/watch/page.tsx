  ...
  useEffect(() => {
    const fetchAllVideos = async () => {
      try {
        ...
        const [videosResponse, postsResponse, albumsResponse] = await Promise.all([
          axios.get(`${API_URL}/videos`),
          axios.get(`${API_URL}/posts/videos`),
          axios.get(`${API_URL}/albums/videos`)
        ]);

        // Combine all videos and sort by creation date
        const allVideos = [
          ...videosResponse.data,
          ...postsResponse.data,
          ...albumsResponse.data
