  ...
  const handleSubmit = (): void => {
    ...
    setTimeout(() => {
      if (formData.username && formData.password) {
        ...
        setTimeout(() => router.push('/dashboard'), 1200); // Redirect after showing popup
      } else {
        showPopup('error', 'Login Failed', 'Please fill in all required fields.');
      }
      setIsLoading(false);
    }, 1500);
  };
              ...
              onClick={() => {
                ...
                setTimeout(() => {
                  if (formData.username && formData.password) {
                    ...
                    setTimeout(() => router.push('/dashboard'), 1200); // Redirect after showing modal
                  } else {
                    setModalMessage({ text: 'Please fill in all required fields.', type: 'error' });
                  }
                  setIsLoading(false);
                }, 1500);
              }}
